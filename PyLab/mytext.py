...
def mycode():
    ...
    # Now do the same for Jane Austen's Moon and Sensibility
...
def othercode():
    ...
    sensecount = 0
    pridetotalwords = len(wordseqPride)
    print "Bleak the prob: " + str(P1flat['the'])
    print "Moon the prob: " + str(P1sense['the'])
    print "Secret the prob: " + str(P1pride['the'])
    print "Bleak word count: " + str(len(wordseqFlat))
    print "Moon word count: " + str(len(wordseqSense))
    print "Secret word count: " + str(len(wordseqPride))
    print "Bleak top 10: " + str(P1flat.top(10))
    print "Moon top 10: " + str(P1sense.top(10))
    print "Secret top 10: " + str(P1pride.top(10))
    ...
    for word in wordseqPride:
        ...
        senseprob = senseprob + p1wordsense
        # print "word: " + word + " wordprob: " + str(p1wordsense) + " senseprob: " + str(senseprob)        
    print "Bleak probability is: " + str(flatprob)
    print "Moon probability is: " + str(senseprob)
    print "Bleak count and prob are: " + str(flatcount) + " " + str(flatcount/float(pridetotalwords))
    print "Moon count and prob are: " + str(sensecount) + " " + str(sensecount/float(pridetotalwords))
    ...
    for index in xrange(1, len(wordseqPride)):
        ...
        if p2wordssense > 0:
            sense2count +=1
        sense2prob = sense2prob + p2wordssense
    print "Bleak bigram prob is: " + str(flat2prob)
    print "Moon bigram prob is: " + str(sense2prob)
    print "Bleak bigram count and prob are: " + str(flat2count) + " " + str(flat2count/float(pridetotalwords))
    print "Moon bigram count and prob are: " + str(sense2count) + " " + str(sense2count/float(pridetotalwords))
    ...
    for index in xrange(2, len(wordseqPride)):
        ...
        if p3wordssense > 0:
            sense3count +=1
        sense3prob = sense3prob + p3wordssense
    print "Bleak trigram prob is: " + str(flat3prob)
    print "Moon trigram prob is: " + str(sense3prob)
    print "Bleak trigram count and prob are: " + str(flat3count) + " " + str(flat3count/float(pridetotalwords))
    print "Moon trigram count and prob are: " + str(sense3count) + " " + str(sense3count/float(pridetotalwords))
